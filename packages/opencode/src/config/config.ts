...
import { serviceUse } from "@anicode-ai/core/effect/service-use"
...
import { Flag } from "@anicode-ai/core/flag/flag"
import { Auth } from "../auth"
import { Env } from "../env"
import { applyEdits, modify } from "jsonc-parser"
import { InstallationLocal, InstallationVersion } from "@anicode-ai/core/installation/version"
import { existsSync } from "fs"
import { Account } from "@/account/account"
import { isRecord } from "@/util/record"
import type { ConsoleState } from "@anicode-ai/core/v1/config/console-state"
import { FSUtil } from "@anicode-ai/core/fs-util"
import { InstanceState } from "@/effect/instance-state"
import { Context, Duration, Effect, Exit, Fiber, Layer, Option, Schema } from "effect"
import { FetchHttpClient, HttpClient, HttpClientRequest } from "effect/unstable/http"
import { EffectFlock } from "@anicode-ai/core/util/effect-flock"
import { containsPath, type InstanceContext } from "../project/instance-context"
import { ConfigV1 } from "@anicode-ai/core/v1/config/config"
import { RemoteAuthError } from "@anicode-ai/core/v1/config/error"
import { ConfigPermissionV1 } from "@anicode-ai/core/v1/config/permission"
import { ConfigPluginV1 } from "@anicode-ai/core/v1/config/plugin"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const loadGlobal = Effect.fnUntraced(function* (env?: Record<string, string>) {
      ...
      if (!Flag.OPENCODE_CONFIG && !Flag.ANICODE_CONFIG_DIR && !Flag.OPENCODE_CONFIG_CONTENT) {
    ...
    const loadInstanceState = Effect.fn("Config.loadInstanceState")(
      function* (ctx: InstanceContext) {
        ...
        if (Flag.ANICODE_CONFIG_DIR) {
          yield* Effect.logDebug("loading config from ANICODE_CONFIG_DIR", { path: Flag.ANICODE_CONFIG_DIR })
        }

        const deps: Fiber.Fiber<void>[] = []

        for (const dir of directories) {
          if (dir.endsWith(".opencode") || dir === Flag.ANICODE_CONFIG_DIR) {
