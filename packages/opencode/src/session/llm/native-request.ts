import type { JsonSchema, LLMRequest, ProviderMetadata } from "@anicode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@anicode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @anicode-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
