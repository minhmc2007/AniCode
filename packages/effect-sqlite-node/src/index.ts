...
export const TypeId: TypeId = "~@anicode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@anicode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@anicode-ai/effect-sqlite-node/NodeSqliteClient")
