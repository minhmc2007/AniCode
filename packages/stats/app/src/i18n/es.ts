export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo textual de AniCode Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a AniCode en GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Probar AniCode",
  ...
  "footer.homeAria": "Inicio de AniCode",
  ...
  "modal.title": "Boletín de AniCode",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de AniCode.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en AniCode",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de AniCode",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de AniCode durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | AniCode Data",
  "model.description":
