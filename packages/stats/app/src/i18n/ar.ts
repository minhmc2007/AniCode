export const dict = {
  "app.title": "ترتيب استخدام نماذج الذكاء الاصطناعي | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "شعار AniCode Data على خلفية داكنة مزخرفة",
  ...
  "header.githubAria": "ضع نجمة لـ AniCode على GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "جرّب AniCode",
  ...
  "footer.homeAria": "صفحة AniCode الرئيسية",
  ...
  "modal.title": "نشرة AniCode الإخبارية",
  ...
  "lab.title": "استخدام وترتيب نماذج {{lab}} للذكاء الاصطناعي | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "قراءة توفر النماذج واستخدام AniCode الأخير.",
  "lab.notFound": "لم تطابق أي نماذج هذا المختبر.",
  "lab.heroPrefix": "استكشف {{count}} من نماذج {{lab}} المستخدمة في AniCode",
  ...
  "lab.shareOfUsage": "{{share}} من استخدام AniCode الأخير",
  "lab.usageTitle": "استخدام رموز {{lab}}",
  "lab.usageDescription": "حجم رموز AniCode اليومي خلال الشهرين الماضيين.",
  ...
  "lab.usage": "الاستخدام",
  "lab.share": "الحصة",
  "model.title": "استخدام {{model}} وتكلفته وترتيبه | AniCode Data",
  "model.description":
