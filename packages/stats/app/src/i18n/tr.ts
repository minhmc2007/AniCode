export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde AniCode Data logosu",
  ...
  "header.githubAria": "GitHub'da AniCode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryAniCode": "AniCode'u dene",
  ...
  "footer.homeAria": "AniCode ana sayfası",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Model kullanılabilirliği ve son AniCode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "AniCode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son AniCode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük AniCode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | AniCode Data",
  "model.description":
