export const dict = {
  "app.title": "KI-Modellnutzungs-Rankings | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "AniCode Data-Wortmarke auf dunklem gemustertem Hintergrund",
  ...
  "header.githubAria": "AniCode auf GitHub mit Stern markieren",
  "header.github": "GitHub",
  "header.tryAniCode": "AniCode ausprobieren",
  ...
  "footer.homeAria": "AniCode-Startseite",
  ...
  "modal.title": "AniCode-Newsletter",
  ...
  "lab.title": "{{lab}} KI-Modellnutzung und Rankings | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Modellverfügbarkeit und aktuelle AniCode-Nutzung werden gelesen.",
  "lab.notFound": "Keine Modelle passten zu diesem Lab.",
  "lab.heroPrefix": "Erkunde {{count}} {{lab}}-Modelle, die in AniCode verwendet werden",
  ...
  "lab.shareOfUsage": "{{share}} der aktuellen AniCode-Nutzung",
  "lab.usageTitle": "{{lab}}-Tokennutzung",
  "lab.usageDescription": "Tägliches AniCode-Tokenvolumen der letzten zwei Monate.",
  ...
  "lab.usage": "Nutzung",
  "lab.share": "Anteil",
  "model.title": "{{model}} Nutzung, Kosten und Rang | AniCode Data",
  "model.description":
