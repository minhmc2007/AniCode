export const dict = {
  "app.title": "Rangeringer for bruk av AI-modeller | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "AniCode Data-ordmerke på en mørk mønstret bakgrunn",
  ...
  "header.githubAria": "Gi AniCode en stjerne på GitHub",
  ...
  "modal.title": "AniCode-nyhetsbrev",
  ...
  "lab.title": "{{lab}} AI-modellbruk og rangeringer | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leser modelltilgjengelighet og nylig AniCode-bruk.",
  "lab.notFound": "Ingen modeller matchet dette laben.",
  "lab.heroPrefix": "Utforsk {{count}} {{lab}}-modeller brukt i AniCode",
  ...
  "lab.shareOfUsage": "{{share}} av nylig AniCode-bruk",
  "lab.usageTitle": "{{lab}} tokenbruk",
  "lab.usageDescription": "Daglig AniCode-tokenvolum over de siste to månedene.",
  ...
  "lab.usage": "Bruk",
  "lab.share": "Andel",
  "model.title": "{{model}} bruk, kostnad og rangering | AniCode Data",
  "model.description":
