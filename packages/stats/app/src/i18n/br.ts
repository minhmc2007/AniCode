export const dict = {
  "app.title": "Ranking de uso de modelos de IA | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo do AniCode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao AniCode no GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Experimente o AniCode",
  ...
  "footer.homeAria": "Início do AniCode",
  ...
  "modal.title": "Newsletter do AniCode",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do AniCode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no AniCode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do AniCode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do AniCode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | AniCode Data",
  "model.description":
