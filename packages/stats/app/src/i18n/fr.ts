export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logo textuel AniCode Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à AniCode sur GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Essayer AniCode",
  ...
  "footer.homeAria": "Accueil AniCode",
  ...
  "modal.title": "Newsletter AniCode",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'AniCode.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans AniCode",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'AniCode",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens AniCode sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | AniCode Data",
  "model.description":
