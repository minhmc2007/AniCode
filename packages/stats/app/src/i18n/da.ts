export const dict = {
  "app.title": "Ranglister for brug af AI-modeller | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "AniCode Data-ordmærke på en mørk mønstret baggrund",
  ...
  "header.githubAria": "Giv AniCode en stjerne på GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Prøv AniCode",
  ...
  "footer.homeAria": "AniCode-forside",
  ...
  "modal.title": "AniCode-nyhedsbrev",
  ...
  "lab.title": "{{lab}} AI-modelbrug og ranglister | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Læser modeltilgængelighed og seneste AniCode-brug.",
  "lab.notFound": "Ingen modeller matchede dette lab.",
  "lab.heroPrefix": "Udforsk {{count}} {{lab}}-modeller brugt i AniCode",
  ...
  "lab.shareOfUsage": "{{share}} af den seneste AniCode-brug",
  "lab.usageTitle": "{{lab}}-tokenbrug",
  "lab.usageDescription": "Daglig AniCode-tokenvolumen over de sidste to måneder.",
  ...
  "lab.usage": "Brug",
  "lab.share": "Andel",
  "model.title": "{{model}} brug, omkostning og rang | AniCode Data",
  "model.description":
