export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo AniCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a AniCode su GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Prova AniCode",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di AniCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in AniCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di AniCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token AniCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | AniCode Data",
  "model.description":
