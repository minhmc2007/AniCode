export const dict = {
  "app.title": "Rankingi użycia modeli AI | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "Znak słowny AniCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę AniCode na GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Wypróbuj AniCode",
  ...
  "footer.homeAria": "Strona główna AniCode",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia AniCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w AniCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia AniCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów AniCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | AniCode Data",
  "model.description":
