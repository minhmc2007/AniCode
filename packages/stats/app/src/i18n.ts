...
const en = {
  "app.title": "AI Model Usage Rankings | AniCode Data",
  "app.description":
  ...
  "app.unfurlAlt": "AniCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star AniCode on GitHub",
  "header.github": "GitHub",
  "header.tryAniCode": "Try AniCode",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | AniCode Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Reading model availability and recent AniCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in AniCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent AniCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | AniCode Data",
  "model.description":
