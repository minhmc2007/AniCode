import { OpenCode } from "@anicode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@anicode-ai/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@anicode-ai/sdk-next/OpenCode") {}
