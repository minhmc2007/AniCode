...
import defaultSoundPath from "@anicode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@anicode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@anicode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@anicode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@anicode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@anicode-ai/ui/audio/yup-01.mp3" with { type: "file" }
