...
import type { Data, Definition, Payload } from "@anicode-ai/schema/event"
...
import { Durable } from "@anicode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@anicode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@anicode-ai/schema/event"
