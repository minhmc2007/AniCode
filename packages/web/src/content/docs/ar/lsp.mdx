---
title: خوادم LSP
description: يتكامل AniCode مع خوادم LSP لديك.
---

يمكن أن يتكامل AniCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي AniCode مع عدة خوادم LSP مدمجة للغات الشائعة:
