...
تتيح مهارات الوكيل لـ AniCode اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج AniCode صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض AniCode المهارات المتاحة في وصف أداة `skill`.
