...
مع AniCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم AniCode سمتنا `opencode`.
...
يأتي AniCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق AniCode مظهر terminal لديهم
...
يدعم AniCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
