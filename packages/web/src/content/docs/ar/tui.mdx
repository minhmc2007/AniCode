---
title: TUI
description: استخدام واجهة المستخدم TUI في AniCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر AniCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل AniCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة AniCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى AniCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من AniCode. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار AniCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
