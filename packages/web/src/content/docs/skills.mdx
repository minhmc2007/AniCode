...
Agent skills let AniCode discover reusable instructions from your repo or home directory.
...
AniCode searches these locations:
...
For project-local paths, AniCode walks up from your current working directory until it reaches the git worktree.
...
AniCode lists available skills in the `skill` tool description.
