...
With AniCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, AniCode uses our own `opencode` theme.
...
AniCode comes with several built-in themes.
...
- Want AniCode to match their terminal's appearance
...
AniCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
