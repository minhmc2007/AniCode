...
Go works like any other provider in AniCode. You subscribe to OpenCode Go and
...
OpenCode Go works like any other provider in AniCode.
...
4. Have **no lock-in** by allowing you to use any other provider with AniCode as well.
