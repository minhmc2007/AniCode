---
title: SDK
description: Typesikker JS-klient for AniCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

AniCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere AniCode programmatisk.
...
Opprett en forekomst av AniCode:
...
Hvis du allerede har en kjørende forekomst av AniCode, kan du opprette en klientforekomst for å koble til den:
