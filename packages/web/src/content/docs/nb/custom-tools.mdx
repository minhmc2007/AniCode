...
description: Lag verktøy som LLM kan kalle inn AniCode.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med AniCode sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
