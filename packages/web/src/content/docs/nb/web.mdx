---
title: Web
description: Bruke AniCode i nettleseren din.
---

AniCode kan kjøres som en nettapplikasjon i nettleseren din, og gir den samme kraftige AI-kodingsopplevelsen uten at du trenger en terminal.

![AniCode Web - Ny økt](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfeldig tilgjengelig port og åpner automatisk AniCode i standard nettleser.
...
Som standard velger AniCode en tilgjengelig port. Du kan spesifisere en port:
...
Som standard binder serveren seg til `127.0.0.1` (kun localhost). Slik gjør du AniCode tilgjengelig på nettverket ditt:
...
Når den er startet, gir nettgrensesnittet tilgang til dine AniCode-økter.
