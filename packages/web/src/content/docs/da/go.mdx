...
Go fungerer som enhver anden udbyder i AniCode. Du abonnerer på OpenCode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med AniCode.
:::
...
OpenCode Go fungerer som enhver anden udbyder i AniCode.
...
Dit [model id](/docs/config/#models) i din AniCode config
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med AniCode.
