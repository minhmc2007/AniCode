---
title: Deling
description: Del dine AniCode-samtaler.
---

AniCodes delingsfunksjon lar deg lage offentlige lenker til dine AniCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, AniCode:
...
AniCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger AniCode manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
