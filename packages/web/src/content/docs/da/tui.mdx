---
title: TUI
description: Brug af AniCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AniCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre AniCode starter TUI for den nuværende mappe.
...
Når du bruger AniCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til AniCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut AniCode. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe AniCode venter efter leader key. Standard er `2000`.
