...
Agentferdigheter lar AniCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
AniCode søker etter disse stedene:
...
For prosjektlokale stier går AniCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
AniCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
