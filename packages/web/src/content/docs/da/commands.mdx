...
Du kan tilføje brugerdefinerede kommandoer gennem AniCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din AniCode [config](/docs/config):
