...
Med AniCode kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger AniCode vårt eget `opencode`-tema.
...
AniCode kommer med flere innebygde temaer.
...
- Vil at AniCode skal matche terminalens utseende
...
AniCode støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
