---
title: Server LSP
description: AniCode si integra con i tuoi server LSP.
---

AniCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

AniCode include diversi server LSP integrati per linguaggi popolari:
