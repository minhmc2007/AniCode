...
Go funziona come qualsiasi altro provider in AniCode. Ti abboni a OpenCode Go e
...
OpenCode Go funziona come qualsiasi altro provider in AniCode.
...
Il [model id](/docs/config/#models) nella tua AniCode config
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con AniCode.
