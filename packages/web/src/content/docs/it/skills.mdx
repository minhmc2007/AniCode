...
Le skill degli agenti permettono a AniCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
AniCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, AniCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
AniCode elenca le skill disponibili nella descrizione dello strumento `skill`.
