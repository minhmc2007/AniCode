...
Las habilidades del agente permiten a AniCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
AniCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, AniCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
AniCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
