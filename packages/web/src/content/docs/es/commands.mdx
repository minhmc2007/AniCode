...
Puede agregar comandos personalizados a través de la configuración AniCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su AniCode [config](/docs/config):
