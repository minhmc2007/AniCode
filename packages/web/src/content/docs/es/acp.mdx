---
title: Soporte ACP
description: Utilice AniCode en cualquier editor compatible con ACP.
---

AniCode admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar AniCode a través de ACP, configure su editor para ejecutar el comando `opencode acp`.

El comando inicia AniCode como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'AniCode' en el selector de agentes de AI Chat.
...
Para usar AniCode como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar AniCode como agente ACP para el chat.
...
AniCode funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración AniCode
