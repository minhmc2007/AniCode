---
title: Compartir
description: Comparte tus conversaciones AniCode.
---

La función para compartir de AniCode te permite crear enlaces públicos a tus conversaciones de AniCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, AniCode:
...
AniCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, AniCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
