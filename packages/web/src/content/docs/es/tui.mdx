---
title: TUI
description: Usando la interfaz de usuario del terminal AniCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AniCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar AniCode se inicia TUI para el directorio actual.
...
Cuando utilice AniCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a AniCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de AniCode. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera AniCode después de la leader key. El valor predeterminado es `2000`.
