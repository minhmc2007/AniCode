---
title: LSP Servers
description: AniCode integrates with your LSP servers.
---

AniCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

AniCode comes with several built-in LSP servers for popular languages:
