...
You can add custom commands through the AniCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your AniCode [config](/docs/config):
