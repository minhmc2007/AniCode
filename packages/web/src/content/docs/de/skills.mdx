...
Agent Skills erlauben AniCode, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
AniCode sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft AniCode vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
AniCode listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
