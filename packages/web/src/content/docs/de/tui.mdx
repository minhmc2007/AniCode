---
title: TUI
description: Arbeite mit AniCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AniCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet AniCode die TUI im aktuellen Verzeichnis.
...
In der AniCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu AniCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet AniCode. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange AniCode nach der leader key wartet. Standard ist `2000`.
