...
Mit AniCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet AniCode das `opencode`-Theme.
...
AniCode liefert mehrere eingebaute Themes mit.
...
- AniCode optisch ans Terminal anpassen wollen
...
AniCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
