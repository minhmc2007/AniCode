---
title: Share
description: Share your AniCode conversations.
---

AniCode's share feature allows you to create public links to your AniCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, AniCode:
...
AniCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, AniCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
