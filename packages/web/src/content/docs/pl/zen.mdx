---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez AniCode.
---
...
OpenCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół AniCode.

Zen działa jak każdy inny dostawca w AniCode. Logujesz się do OpenCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z AniCode.
:::
...
OpenCode Zen działa jak każdy inny dostawca w AniCode.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji AniCode używa formatu
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. AniCode używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling-3.0-flash Free jest dostępny w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w AniCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w AniCode także dowolnego innego dostawcy.
