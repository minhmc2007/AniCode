...
U AniCode mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, AniCode koristi nasu `opencode` temu.
...
AniCode dolazi sa vise ugradenih tema.
...
- Zele da AniCode odgovara izgledu njihovog terminala
...
AniCode podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
