...
Go radi kao bilo koji drugi provajder u AniCode-u. Pretplatite se na OpenCode Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili AniCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa AniCode-om.
:::
...
OpenCode Go radi kao bilo koji drugi provajder u AniCode-u.
...
[Model id](/docs/config/#models) u vašoj AniCode konfiguraciji
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz AniCode koristite i bilo kojeg drugog provajdera.
