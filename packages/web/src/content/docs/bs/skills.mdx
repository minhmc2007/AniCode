...
Agent skills omogucavaju AniCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
AniCode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, AniCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
AniCode navodi dostupne skills u opisu `skill` alata.
