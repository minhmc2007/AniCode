---
title: LSP serveri
description: AniCode se integriše sa vašim LSP serverima.
---

AniCode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

AniCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
