---
title: TUI
description: Korištenje korisničkog interfejsa AniCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AniCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje AniCode pokreće TUI za trenutni direktorij.
...
Kada koristite AniCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u AniCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz AniCode. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo AniCode čeka nakon leader key. Podrazumijevano je `2000`.
