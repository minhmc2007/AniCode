...
Vous pouvez ajouter des commandes personnalisées via la configuration AniCode ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre AniCode [config](/docs/config) :
