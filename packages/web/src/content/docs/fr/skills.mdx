...
Les compétences d'agent permettent à AniCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
AniCode recherche ces emplacements :
...
Pour les chemins locaux du projet, AniCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
AniCode répertorie les compétences disponibles dans la description de l'outil `skill`.
