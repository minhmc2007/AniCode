...
import type { Config, OpencodeClient, Project } from "@anicode-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@anicode-ai/client/promise"
import type { NormalizedProviderListResponse } from "@anicode-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
