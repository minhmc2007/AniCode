...
beforeAll(async () => {
  ...
  mock.module("@anicode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@anicode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@anicode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@anicode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
