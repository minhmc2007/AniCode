import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@anicode-ai/sdk/v2"
import { SessionTurn } from "@anicode-ai/session-ui/session-turn"
import { SessionReview } from "@anicode-ai/session-ui/session-review"
import { DataProvider } from "@anicode-ai/session-ui/context"
import { FileComponentProvider } from "@anicode-ai/ui/context/file"
import { WorkerPoolProvider } from "@anicode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@anicode-ai/ui/logo"
import { IconButton } from "@anicode-ai/ui/icon-button"
import { ProviderIcon } from "@anicode-ai/ui/provider-icon"
import { iife } from "@anicode-ai/core/util/iife"
import { Binary } from "@anicode-ai/core/util/binary"
import { NamedError } from "@anicode-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@anicode-ai/ui/tabs"
import { MessageNav } from "@anicode-ai/session-ui/message-nav"
import { FileSSR } from "@anicode-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@anicode-ai/session-ui/pierre/worker").then((m) => ({
