...
- `AniCode` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `AniCode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `AniCode` inside commands, URLs, package names, or code literals
